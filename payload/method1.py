...
def banner():
  os.system("clear")
  print(f"""{fc} ____  ____ _____   ____   ____  __  __  ____  __  _    __  _______  _     ____  _  _____ 
| _) \/ () \| () ) / () \ | ===||  \/  |/ () \|  \| |   \ \/ /| ()_)| |__ / () \| ||_   _|{fres}
|____/\____/|_|\_\/__/\__\|____||_|\/|_|\____/|_|\__|   /_/\_\|_|   |____|\____/|_|  |_|   
BY TPNET CYBER
t.me/tpnetofc
DORAEMON XPLOIT IS POWERFULL TOOLS VULN SQLI CHECKER
""")
print("\n what's wrong master? Do you have love problems again? And what is your aim in carrying out this illegal program?\n")
